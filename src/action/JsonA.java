...
public class JsonA extends ActionSupport implements ServletRequestAware{
	...
	public String executeAjax() {
		...
		try {
			...
			String sql = "SELECT a.XHDM, a.HEALTH_07, a.HEALTH_08, a.HEALTH_09, a.HEALTH_10, a.HEALTH_11, a.HEALTH_12, a.HEALTH_13, a.HEALTH_14, a.HEALTH_15, a.HEALTH_16, b.HZZM, b.JSDATE FROM container_health a LEFT JOIN jzx_dz_location b ON a.XHDM=b.XHDM WHERE";
			sql += " a.XHDM = ?";
